...
public class AllJobActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Data,AllJobPostViewHolder>adapter = new FirebaseRecyclerAdapter<Data, AllJobPostViewHolder>(firebaseRecyclerOptions) {
            @Override
            protected void onBindViewHolder(@NonNull AllJobPostViewHolder allJobPostViewHolder, int i, @NonNull Data model) {
                allJobPostViewHolder.setJobTitle(model.getTitle());
                allJobPostViewHolder.setJobDate(model.getDate());
                allJobPostViewHolder.setJobDescription(model.getDescription());
                allJobPostViewHolder.setJobSkills(model.getSkills());
                allJobPostViewHolder.setJobSalary(model.getSalary());

                //passing details to actiivity job details
            ...
            public AllJobPostViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(getApplicationContext()).inflate(R.layout.alljobpost, parent, false);
